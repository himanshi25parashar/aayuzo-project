        ...
        <div className="relative w-full overflow-hidden">
            ...
            <div className="relative w-full h-screen overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto px-6 pt-24 sm:pt-28 md:pt-32 lg:pt-40">
                    ...
                    {/* Right Side Images */}
                    <div className="relative flex justify-center lg:justify-end w-full lg:w-1/2 mt-12 lg:mt-0">
                        {/* Large Image (Hair) */}
                        <img
                            ...
                            w-40 h-40 sm:w-52 sm:h-52 md:w-64 md:h-64 lg:w-[420px] lg:h-auto
                        ...
                        <img
                            ...
                            w-28 h-28 sm:w-36 sm:h-36 md:w-40 md:h-40 lg:w-64 lg:h-auto
