        ...
        <section className="luxury-section salon-section relative w-full py-20 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 text-center">
                ...
                <p className="luxury-sub mt-4 max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
                    Explore our curated selection of luxury salons featuring expert stylists, serene ambiance, and
                    exceptional beauty experiences — crafted to bring elegance and confidence to every visit.
                </p>
                ...
                <div className="hidden lg:grid mt-14 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                    {salons.map((salon) => (
                        <div key={salon.id} className="salon-card group relative overflow-hidden rounded-2xl shadow-xl">
                            <img
                                src={salon.image}
                                alt={salon.name}
                            ...
                            <div className="absolute bottom-6 left-0 right-0 px-5 text-center z-10">
                                <h3 className="salon-title text-2xl font-semibold mb-2">{salon.name}</h3>
                                <p className="salon-location text-sm text-gray-300">{salon.location}</p>
                ...
                <div className="hidden lg:block mt-14">
                    <Link to="/Our-Salon" className="luxury-explore-btn">
                        Explore All Salons →
                    </Link>
                </div>
                ...
                <div className="block lg:hidden mt-12">
                    ...
                    >
                        {salons.map((salon) => (
                            <SwiperSlide key={salon.id}>
                                <div className="salon-card relative rounded-2xl overflow-hidden shadow-lg">
                                    <img src={salon.image} alt={salon.name} className="w-full h-72 object-cover" />
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                                    <div className="absolute bottom-6 left-0 right-0 px-5 text-center text-white">
                                        <h3 className="salon-title text-xl font-semibold mb-2">{salon.name}</h3>
                        ...
                        <SwiperSlide>
                            <div className="explore-card flex flex-col items-center justify-center h-72 rounded-2xl shadow-lg relative overflow-hidden">
                                {/* Subtle gold radial glow */}
                                <div className="explore-glow"></div>

                                <h3 className="text-lg sm:text-xl text-white font-medium mb-4 relative z-10">
                                    Explore More Luxury Salons
                                </h3>

                                <Link to="/Our-Salon" className="luxury-explore-btn relative z-10">
                                    Explore All Salons →
                                </Link>
                            </div>
                        </SwiperSlide>
